...
s32 lake_in_the_lungs_init__(
    struct a_moonlit_walk *AMW, 
    struct amw_workload   *work_array, 
    u32                    workload_count, 
    void                  *context) 
{
    (void)AMW;
...
s32 lake_in_the_lungs_simulation__(
    struct a_moonlit_walk *AMW, 
...
s32 lake_in_the_lungs_rendering__(
    struct a_moonlit_walk *AMW, 
    struct amw_workload   *work, 
    void                  *context)
{
...
s32 lake_in_the_lungs_gpuexec__(
    struct a_moonlit_walk *AMW, 
    struct amw_workload   *work, 
    void                  *context)
{
...
s32 amw_main(struct amw_hints *hints, s32 argc, char **argv)
{
    ...
    hints->callbacks.fini = lake_in_the_lungs_fini__;
