...
static s32 hadal_wayland_display_init(struct hadopelagic *hadal, struct ipomoea *ia, u32 width, u32 height, const char *title)
{
    (void)ia; // TODO
...
s32 hadal_wayland_entry_point(struct hadopelagic *hadal, struct ipomoea *ia)
{
    (void)ia; // TODO
