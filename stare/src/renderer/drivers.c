...
extern b32 vulkan_open_driver(struct vulkan_instance_api *api)
{
    api->module = NULL;
...
extern void vulkan_close_driver(struct vulkan_instance_api *api)
{
    if (api->module)
    ...
    u64                         device_extensions)
{
    ...
    {
        log_error("Can't load Vulkan core 1.1 device procedures. 1.1 is a minimal targetted Vulkan version.");
        return result_error_missing_procedure;
    }

    /* core 1.2 */
    b32 api_version_12 = device_api_version >= VK_MAKE_API_VERSION(0,1,2,0); 
    if (api_version_12) {
        ...
        if (device_extensions & vulkan_extension_buffer_device_address_bit) {
            api->vkGetBufferDeviceAddress = (PFN_vkGetBufferDeviceAddressKHR)(void *)device_proc_address(vk, device, "vkGetBufferDeviceAddressKHR");
            api->vkGetBufferOpaqueCaptureAddress = (PFN_vkGetBufferOpaqueCaptureAddressKHR)(void *)device_proc_address(vk, device, "vkGetBufferOpaqueCaptureAddressKHR");
            api->vkGetDeviceMemoryOpaqueCaptureAddress = (PFN_vkGetDeviceMemoryOpaqueCaptureAddressKHR)(void *)device_proc_address(vk, device, "vkGetDeviceMemoryOpaqueCaptureAddressKHR");
        }
        if (device_extensions & vulkan_extension_draw_indirect_count_bit) {
            api->vkCmdDrawIndexedIndirectCount = (PFN_vkCmdDrawIndexedIndirectCountKHR)(void *)device_proc_address(vk, device, "vkCmdDrawIndexedIndirectCountKHR");
            api->vkCmdDrawIndirectCount = (PFN_vkCmdDrawIndirectCountKHR)(void *)device_proc_address(vk, device, "vkCmdDrawIndirectCountKHR");
        }
        if (device_extensions & vulkan_extension_host_query_reset_bit) {
            api->vkResetQueryPool = (PFN_vkResetQueryPoolEXT)(void *)device_proc_address(vk, device, "vkResetQueryPoolEXT");
        }
        if (device_extensions & vulkan_extension_timeline_semaphore_bit) {
            api->vkGetSemaphoreCounterValue = (PFN_vkGetSemaphoreCounterValueKHR)(void *)device_proc_address(vk, device, "vkGetSemaphoreCounterValueKHR");
            api->vkSignalSemaphore = (PFN_vkSignalSemaphoreKHR)(void *)device_proc_address(vk, device, "vkSignalSemaphoreKHR");
            api->vkWaitSemaphores = (PFN_vkWaitSemaphoresKHR)(void *)device_proc_address(vk, device, "vkWaitSemaphoresKHR");
        }
    }
    ...
    {
        log_warn("Can't load Vulkan core 1.2 procedures or some extension commands: \n"
                 "    Vulkan API 1.2               - %b\n"
                 "    VK_KHR_buffer_device_address - %b\n"
                 "    VK_KHR_draw_indirect_count   - %b\n"
                 "    VK_KHR_timeline_semaphore    - %b", api_version_12,
                 (api->vkGetBufferDeviceAddress && api->vkGetBufferOpaqueCaptureAddress && api->vkGetDeviceMemoryOpaqueCaptureAddress),
                 (api->vkCmdDrawIndexedIndirectCount && api->vkCmdDrawIndirectCount),
                 (api->vkGetSemaphoreCounterValue && api->vkSignalSemaphore && api->vkWaitSemaphores));
        if (api_version_12) return result_error_missing_procedure;
    }

    /* core 1.3 */
    b32 api_version_13 = device_api_version >= VK_MAKE_API_VERSION(0,1,3,0); 
    if (api_version_13) {
    ...
    if (!api->vkCmdBeginRendering || 
        ...
        !api->vkGetDeviceBufferMemoryRequirements ||
        !api->vkGetDeviceImageMemoryRequirements ||
        !api->vkGetDeviceImageSparseMemoryRequirements)
    {
        log_warn("Can't load Vulkan core 1.3 procedures or some extension commands: \n"
                 "    Vulkan API 1.3           - %b\n"
                 "    VK_KHR_dynamic_rendering - %b\n"
                 "    VK_KHR_maintenance4      - %b", api_version_13,
                 (api->vkCmdBeginRendering && api->vkCmdEndRendering),
                 (api->vkGetDeviceBufferMemoryRequirements && api->vkGetDeviceImageMemoryRequirements && api->vkGetDeviceImageSparseMemoryRequirements));
        if (api_version_13) return result_error_missing_procedure;
    }

    /* core 1.4 */
    b32 api_version_14 = device_api_version >= VK_MAKE_API_VERSION(0,1,4,0);
    if (api_version_14) {
        api->vkCmdBindIndexBuffer2 = (PFN_vkCmdBindIndexBuffer2)(void *)device_proc_address(vk, device, "vkCmdBindIndexBuffer2");
        api->vkGetDeviceImageSubresourceLayout = (PFN_vkGetDeviceImageSubresourceLayout)(void *)device_proc_address(vk, device, "vkCmdBindIndexBuffer2");
        api->vkGetImageSubresourceLayout2 = (PFN_vkGetImageSubresourceLayout2)(void *)device_proc_address(vk, device, "vkGetImageSubresourceLayout2");
        api->vkGetRenderingAreaGranularity = (PFN_vkGetRenderingAreaGranularity)(void *)device_proc_address(vk, device, "vkGetRenderingAreaGranularity");
    } else {
        if (device_extensions & vulkan_extension_maintenance5_bit) {
            api->vkCmdBindIndexBuffer2 = (PFN_vkCmdBindIndexBuffer2)(void *)device_proc_address(vk, device, "vkCmdBindIndexBuffer2");
            api->vkGetDeviceImageSubresourceLayout = (PFN_vkGetDeviceImageSubresourceLayout)(void *)device_proc_address(vk, device, "vkCmdBindIndexBuffer2");
            api->vkGetImageSubresourceLayout2 = (PFN_vkGetImageSubresourceLayout2)(void *)device_proc_address(vk, device, "vkGetImageSubresourceLayout2");
            api->vkGetRenderingAreaGranularity = (PFN_vkGetRenderingAreaGranularity)(void *)device_proc_address(vk, device, "vkGetRenderingAreaGranularity");
    ...
    if (!api->vkCmdBindIndexBuffer2 ||
        !api->vkGetDeviceImageSubresourceLayout ||
        !api->vkGetImageSubresourceLayout2 ||
        !api->vkGetRenderingAreaGranularity)
    {
        log_warn("Can't load Vulkan core 1.4 procedures or some extension commands: \n"
                 "    Vulkan API 1.4                      - %b\n"
                 "    VK_KHR_dynamic_rendering_local_read - %b\n"
                 "    VK_KHR_maintenance5                 - %b", api_version_14,
                 (api->vkCmdSetRenderingAttachmentLocations && api->vkCmdSetRenderingInputAttachmentIndices),
                 (api->vkCmdBindIndexBuffer2 && api->vkGetDeviceImageSubresourceLayout && api->vkGetImageSubresourceLayout2 && api->vkGetRenderAreaGranularity));
        if (api_version_14) return result_error_missing_procedure;
    }
