...
extern void a_moonlit_walk_simulation_tear__(struct amw_workload *work);
...
extern void a_moonlit_walk_rendering_tear__(struct amw_workload *work);
...
extern void a_moonlit_walk_gpuexec_tear__(struct amw_workload *work);
