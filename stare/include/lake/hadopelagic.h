...
typedef s32 (*PFN_hadal_entry_point)(struct hadopelagic *hadal, struct ipomoea *ia);
...
AMWAPI s32 hadal_wayland_entry_point(struct hadopelagic *hadal, struct ipomoea *ia);
AMWAPI s32 hadal_headless_entry_point(struct hadopelagic *hadal, struct ipomoea *ia);
/** Select the first appropriate display backend. */
AMWAPI s32 hadal_entry_point(struct hadopelagic *hadal, struct ipomoea *ia);
...
typedef s32 (*PFN_hadal_display_init)(struct hadopelagic *hadal, struct ipomoea *ia, u32 width, u32 height, const char *title);
