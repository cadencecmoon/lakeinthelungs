 ...
 *  as a uint32_t value, device extensions are represented as uint64_t values. We target a minimal 
 *  version of Vulkan core 1.1, and require the dynamic_rendering extensions. */
enum vulkan_extensions {
    ...
    vulkan_extension_maintenance5_bit                       = (1ull << 21), /**< VK_KHR_maintenance5 */
    /* core 1.3, for backwards compatibility */
    vulkan_extension_dynamic_rendering_bit                  = (1ull << 25), /**< VK_KHR_dynamic_rendering */
    vulkan_extension_maintenance4_bit                       = (1ull << 26), /**< VK_KHR_maintenance4 */
    /* core 1.2, for backwards compatibility */
    vulkan_extension_buffer_device_address_bit              = (1ull << 32), /**< VK_KHR_buffer_device_address */
    vulkan_extension_draw_indirect_count_bit                = (1ull << 33), /**< VK_KHR_draw_indirect_count */
    vulkan_extension_descriptor_indexing_bit                = (1ull << 34), /**< VK_EXT_descriptor_indexing */
    vulkan_extension_host_query_reset_bit                   = (1ull << 35), /**< VK_EXT_host_query_reset */
    vulkan_extension_timeline_semaphore_bit                 = (1ull << 36), /**< VK_KHR_timeline_semaphore */
    vulkan_extension_vulkan_memory_model_bit                = (1ull << 37), /**< VK_KHR_vulkan_memory_model */
};
...
#define vulkan_extension_mask_api_12 \
    (vulkan_extension_buffer_device_address_bit | \
     vulkan_extension_draw_indirect_count_bit   | \
     vulkan_extension_descriptor_indexing_bit   | \
     vulkan_extension_host_query_reset_bit      | \
     vulkan_extension_timeline_semaphore_bit    | \
     vulkan_extension_vulkan_memory_model_bit)
#define vulkan_extension_mask_api_13 \
    (vulkan_extension_dynamic_rendering_bit | \
     vulkan_extension_maintenance4_bit)
#define vulkan_extension_mask_api_14 \
    (vulkan_extension_dynamic_rendering_local_read_bit | \
     vulkan_extension_maintenance5_bit)
...
/** Bundles a buffer handle with offset and size. */
...
/** Bundles a shader module with it's SPIR-V code. */
struct vulkan_shader {
    VkShaderModule              module;         /**< The vulkan object for the compiled shader module. */
    usize                       spirv_size;     /**< The size of the compiled SPIR-V code in bytes. */
    u32                        *spirv_code;     /**< The compiled SPIR-V code. */
};

/** Specifies a single descriptor layout. */
struct vulkan_descriptor_request {
...
b32 vulkan_open_driver(struct vulkan_instance_api *vk);
...
s32 vulkan_create_swapchain_surface(
...
s32 vulkan_create_descriptor_sets(
    struct vulkan_pipeline                 *pipeline,
    struct vulkan_device                   *device,
    const struct vulkan_descriptor_request *descriptor_request,
...
void vulkan_complete_descriptor_set_writes(
...
s32 vulkan_create_aligned_buffers(
    struct vulkan_buffer     *buffers,
    struct vulkan_device     *device,
...
AMW_INLINE s32 vulkan_create_buffers(
    ...
    u32                       buffer_count)
{
    return vulkan_create_aligned_buffers(buffers, device, buffer_infos, buffer_count, 1);
}
...
s32 vulkan_copy_buffers_and_images(
