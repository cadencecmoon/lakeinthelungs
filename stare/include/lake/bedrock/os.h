...
/** Read CPU info (on linux: /proc/cpuinfo). */
AMWAPI void bedrock_cpuinfo(u32 *out_threads, u32 *out_cores, u32 *out_packages);

/** Read system RAM info (on linux: /proc/meminfo). */
...
AMWAPI void bedrock_thread_affinity(u8 *stack_memory, thread_t *threads, ssize thread_count, ssize begin_cpu_index);
