...
typedef s32 (*PFN_silver_entry_point)(struct silver *silv, struct ipomoea *ia);
...
AMWAPI s32 silver_pipewire_entry_point(struct silver *silv, struct ipomoea *ia);
AMWAPI s32 silver_dummy_entry_point(struct silver *silv, struct ipomoea *ia);
/** Select the first appropriate audio backend supported by this build. */
AMWAPI s32 silver_entry_point(struct silver *silv, struct ipomoea *ia);
