...
There are no real dependencies, not even the standard C library, and the engine is supposed to run (in a limited way) even without host support for stuff like audio or Vulkan drivers.
