...
#ifndef _AMW_COMMON_DEFINES_H
#define _AMW_COMMON_DEFINES_H

/* using only freestanding headers, provided by the compiler */
#include <stdint.h>
#include <stddef.h>
#include <stdarg.h>
#include <limits.h>
...
#ifndef AMWCALL
    #if defined(AMW_PLATFORM_WINDOWS) && !defined(AMW_CC_GNUC_VERSION)
        #define AMWCALL __cdecl
    #else
        #define AMWCALL
    #endif
#endif
