...
enum lake_result {
    ...
    lake_result_retry                                                       = 12,
    lake_result_compile_required                                            = 13,
    /* common errors */
    ...
    lake_result_error_not_permitted                                         = -22,
    lake_result_error_compression_exhausted                                 = -22,
    /* xaku (renderer codes) */
    lake_result_missing_extension                                      = (1 << 16) + 0,
    lake_result_invalid_buffer_id                                      = (1 << 16) + 1,
    lake_result_invalid_texture_id                                     = (1 << 16) + 2,
    lake_result_invalid_texture_view_id                                = (1 << 16) + 3,
    lake_result_invalid_sampler_id                                     = (1 << 16) + 4,
    lake_result_buffer_double_free                                     = (1 << 16) + 5,
    lake_result_texture_double_free                                    = (1 << 16) + 6,
    lake_result_texture_view_double_free                               = (1 << 16) + 7,
    lake_result_sampler_double_free                                    = (1 << 16) + 8,
    lake_result_invalid_buffer_assembly                                = (1 << 16) + 9,
    lake_result_invalid_texture_assembly                               = (1 << 16) + 10,
    lake_result_invalid_texture_view_assembly                          = (1 << 16) + 11,
    lake_result_invalid_sampler_assembly                               = (1 << 16) + 12,
    lake_result_command_list_completed                                 = (1 << 16) + 13,
    lake_result_command_list_not_completed                             = (1 << 16) + 14,
    lake_result_invalid_clear_value                                    = (1 << 16) + 15,
    lake_result_buffer_not_host_visible                                = (1 << 16) + 16,
    lake_result_buffer_not_device_visible                              = (1 << 16) + 17,
    lake_result_incomplete_command_list                                = (1 << 16) + 18,
    lake_result_device_does_not_support_buffer_count                   = (1 << 16) + 19,
    lake_result_device_does_not_support_texture_count                  = (1 << 16) + 20,
    lake_result_device_does_not_support_sampler_count                  = (1 << 16) + 21,
    lake_result_failed_to_create_null_buffer                           = (1 << 16) + 22,
    lake_result_failed_to_create_null_texture                          = (1 << 16) + 23,
    lake_result_failed_to_create_null_texture_view                     = (1 << 16) + 24,
    lake_result_failed_to_create_null_sampler                          = (1 << 16) + 25,
    lake_result_failed_to_create_buffer                                = (1 << 16) + 26,
    lake_result_failed_to_create_texture                               = (1 << 16) + 27,
    lake_result_failed_to_create_texture_view                          = (1 << 16) + 28,
    lake_result_failed_to_create_default_image_view                    = (1 << 16) + 29,
    lake_result_failed_to_create_sampler                               = (1 << 16) + 30,
    lake_result_failed_to_create_bda_buffer                            = (1 << 16) + 31,
    lake_result_failed_to_submit_device_init_commands                  = (1 << 16) + 32,
    lake_result_invalid_buffer_range                                   = (1 << 16) + 33,
    lake_result_invalid_buffer_offset                                  = (1 << 16) + 34,
    lake_result_no_suitable_format_found                               = (1 << 16) + 36,
    lake_result_range_out_of_bounds                                    = (1 << 16) + 37,
    lake_result_no_suitable_device_found                               = (1 << 16) + 38,
    lake_result_exceeded_max_buffers                                   = (1 << 16) + 39,
    lake_result_exceeded_max_textures                                  = (1 << 16) + 40,
    lake_result_exceeded_max_texture_views                             = (1 << 16) + 41,
    lake_result_exceeded_max_samplers                                  = (1 << 16) + 42,
    lake_result_device_surface_unsupported_present_mode                = (1 << 16) + 43,
    lake_result_command_references_invalid_buffer_id                   = (1 << 16) + 44,
    lake_result_command_references_invalid_texture_id                  = (1 << 16) + 45,
    lake_result_command_references_invalid_texture_view_id             = (1 << 16) + 46,
    lake_result_command_references_invalid_sampler_id                  = (1 << 16) + 47,
    lake_result_invalid_acceleration_structure_id                      = (1 << 16) + 48,
    lake_result_exceeded_max_acceleration_structures                   = (1 << 16) + 49,
    lake_result_device_does_not_support_raytracing                     = (1 << 16) + 50,
    lake_result_device_does_not_support_mesh_shader                    = (1 << 16) + 51,
    lake_result_device_does_not_support_acceleration_structure_count   = (1 << 16) + 52,
    lake_result_invalid_tlas_id                                        = (1 << 16) + 53,
    lake_result_invalid_blas_id                                        = (1 << 16) + 54,
    lake_result_invalid_without_enabling_ray_tracing                   = (1 << 16) + 55,
    lake_result_no_compute_pipeline_bound                              = (1 << 16) + 56,
    lake_result_no_raster_pipeline_bound                               = (1 << 16) + 57,
    lake_result_no_raytracing_pipeline_bound                           = (1 << 16) + 58,
    lake_result_no_pipeline_bound                                      = (1 << 16) + 59,
    lake_result_pushconstant_range_exceeded                            = (1 << 16) + 60,
    lake_result_mesh_shader_not_device_enabled                         = (1 << 16) + 61,
    lake_result_shader_pipeline_compile_required                       = (1 << 16) + 62,
    lake_result_error_incompatible_display                             = (1 << 16) + 63,
    lake_result_error_invalid_shader                                   = (1 << 16) + 64,
    lake_result_error_image_usage_not_supported_khr                    = (1 << 16) + 65,
    lake_result_error_video_picture_layout_not_supported               = (1 << 16) + 66,
    lake_result_error_video_profile_operation_not_supported            = (1 << 16) + 67,
    lake_result_error_video_profile_format_not_supported               = (1 << 16) + 68,
    lake_result_error_video_profile_codec_not_supported                = (1 << 16) + 69,
    lake_result_error_video_std_version_not_supported                  = (1 << 16) + 70,
    lake_result_error_full_screen_exclusive_mode_lost                  = (1 << 16) + 71,
    lake_result_error_invalid_drm_format_modifier_plane_layout         = (1 << 16) + 72,
    lake_result_error_copy_out_of_bounds                               = (1 << 16) + 73,
    lake_result_error_no_graphics_queue_found                          = (1 << 16) + 74,
    lake_result_error_could_not_query_queue                            = (1 << 16) + 75,
    lake_result_error_invalid_queue                                    = (1 << 16) + 76,
    lake_result_error_cmd_list_submit_queue_family_mismatch            = (1 << 16) + 77,
    lake_result_error_present_queue_family_mismatch                    = (1 << 16) + 78,
    lake_result_error_invalid_queue_family                             = (1 << 16) + 79,
    lake_result_error_invalid_device_index                             = (1 << 16) + 80,
    lake_result_error_device_not_supported                             = (1 << 16) + 81,
    lake_result_error_no_suitable_device_found                         = (1 << 16) + 82,
    lake_result_error_compute_family_cmd_on_transfer_queue_recorder    = (1 << 16) + 83,
    lake_result_error_main_family_cmd_on_transfer_queue_recorder       = (1 << 16) + 84,
    lake_result_error_main_family_cmd_on_compute_queue_recorder        = (1 << 16) + 85,
    lake_result_error_device_capacity_reached                          = (1 << 16) + 86,
