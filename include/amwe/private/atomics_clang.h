...
#error The 'CLANG' atomics header must not be included outside of 'bedrock.h'.
#endif
...
#define LAKE_ATOMIC_BOOL_LOCK_FREE      __CLANG_ATOMIC_BOOL_LOCK_FREE
#define LAKE_ATOMIC_CHAR_LOCK_FREE      __CLANG_ATOMIC_CHAR_LOCK_FREE
#define LAKE_ATOMIC_SHORT_LOCK_FREE     __CLANG_ATOMIC_SHORT_LOCK_FREE
#define LAKE_ATOMIC_INT_LOCK_FREE       __CLANG_ATOMIC_INT_LOCK_FREE
#define LAKE_ATOMIC_LONG_LOCK_FREE      __CLANG_ATOMIC_LONG_LOCK_FREE
#define LAKE_ATOMIC_LLONG_LOCK_FREE     __CLANG_ATOMIC_LLONG_LOCK_FREE
#define LAKE_ATOMIC_POINTER_LOCK_FREE   __CLANG_ATOMIC_POINTER_LOCK_FREE

#define lake_atomic_init(object, value) \
    __c11_atomic_init(object, value)
...
#define lake_atomic_is_lock_free(obj) \
    __c11_atomic_is_lock_free(lake_sizeof(obj))

#define lake_atomic_store_explicit  __c11_atomic_store
