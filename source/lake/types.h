...
typedef enum : s32 {
    ...
    LAKE_ERROR_TOO_MANY_OBJECTS                                      = -8,
    LAKE_ERROR_INCOMPATIBLE_DRIVER                                   = -9,
    LAKE_ERROR_EXTENSION_NOT_PRESENT                                 = -10,
    LAKE_ERROR_FEATURE_NOT_PRESENT                                   = -11,
    LAKE_ERROR_LAYER_NOT_PRESENT                                     = -12,
    LAKE_ERROR_DEVICE_LOST                                           = -13,
    LAKE_ERROR_SURFACE_LOST                                          = -14,
    LAKE_ERROR_NATIVE_WINDOW_IN_USE                                  = -15,
    LAKE_ERROR_OUT_OF_DATE                                           = -16,
    LAKE_ERROR_OUT_OF_RANGE                                          = -17,
    LAKE_ERROR_MEMORY_MAP_FAILED                                     = -18,
    LAKE_ERROR_INVALID_EXTERNAL_HANDLE                               = -19,
    LAKE_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS                        = -20,
    LAKE_ERROR_PANIC                                                 = -420,
} lake_result;
