...
#define lake_atomic_flag volatile bool
#define lake_atomic_flag_init {0}

LAKE_FORCE_INLINE bool lake_atomic_flag_test_and_set_explicit(volatile bool *flag, enum lake_memory_model model)
{
    s8 o = 0;
    return lake_atomic_compare_exchange_strong((LAKE_ATOMIC(s8)*)flag, &o, 1, model) ? 0 : 1;
}
