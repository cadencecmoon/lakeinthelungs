...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_scale_sse2(mat4 m, float s) 
{
    f128 x0;
    x0 = _mm_set1_ps(s);
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_transp_sse2(mat4 m, mat4 dest) 
{
    f128 r0, r1, r2, r3;
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_mul_sse2(mat4 m1, mat4 m2, mat4 dest) 
{
    /* D = R * L (column-major) */
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_mulv_sse2(mat4 m, vec4 v, vec4 dest) 
{
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE f32 lake_mat4_det_sse2(mat4 m) 
{
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_inv_fast_sse2(mat4 m, mat4 dest) 
{
    f128 r0, r1, r2, r3,
         v0, v1, v2, v3,
         t0, t1, t2, t3, t4, t5,
...
LAKE_NONNULL_ALL
LAKE_FORCE_INLINE void lake_mat4_inv_sse2(mat4 m, mat4 dest) 
{
    f128 r0, r1, r2, r3,
         v0, v1, v2, v3,
         t0, t1, t2, t3, t4, t5,
