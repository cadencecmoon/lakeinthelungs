...
/* c23 fallback */
#if !defined(__cplusplus) && ((defined(__STDC_VERSION__) && (__STDC_VERSION__ < 202311L)) || defined(LAKE_CC_MSVC_VERSION))
...
#if defined(LAKE_CC_MSVC_VERSION)
/* `while(0,0)` tricks MSVC /W4 warning level into thinking this condition isn't constant */
#define LAKE_NULL_WHILE_LOOP_CONDITION (0,0)
#else
#define LAKE_NULL_WHILE_LOOP_CONDITION (0)
#endif
