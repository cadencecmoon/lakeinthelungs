...
#include "shading_pass.frag.glsl.spv.h"
#include "shading_pass.vert.glsl.spv.h"
const size_t shading_pass_vert_glsl_size = sizeof(shading_pass_vert_glsl_spv);
const size_t shading_pass_frag_glsl_size = sizeof(shading_pass_frag_glsl_spv);
