...
extern RIVENS_TEAR(a_moonlit_walk_simulation_tear__, amw_workload *work);
...
extern RIVENS_TEAR(a_moonlit_walk_rendering_tear__, amw_workload *work);
...
extern RIVENS_TEAR(a_moonlit_walk_gpuexec_tear__, amw_workload *work);
