#ifndef _AMW_HADAL_WAYLAND_H
#define _AMW_HADAL_WAYLAND_H
...
#define _HADAL_WAYLAND_MONITOR_STATE  struct monitor_wayland wl;
#define _HADAL_WAYLAND_WINDOW_STATE   struct window_wayland wl;
#define _HADAL_WAYLAND_PLATFORM_STATE struct hadal_wayland wl;
#else
#define _HADAL_WAYLAND_MONITOR_STATE
#define _HADAL_WAYLAND_WINDOW_STATE
#define _HADAL_WAYLAND_PLATFORM_STATE
