...
extern void thread_create(thread_t *thread, void *(*procedure)(void *), void *argument);
...
extern size_t thread_index(thread_t *threads, size_t thread_count);
...
extern void thread_affinity(uint8_t *stack_temp, thread_t *threads, size_t thread_count, size_t start_index);
...
extern void riven_split_and_unchain(
        struct riven *riven,
...
extern void riven_unchain_exile(riven_chain_t chain);
...
extern size_t riven_unveil_rift(
        void *riven_memory,
