...
#define wl_cursor_theme_load HADAL_WAYLAND.cursor_theme_load
#define wl_cursor_theme_destroy HADAL_WAYLAND.cursor_theme_destroy
#define wl_cursor_theme_get_cursor HADAL_WAYLAND.cursor_theme_get_cursor
#define wl_cursor_image_get_buffer HADAL_WAYLAND.cursor_image_get_buffer
#define wl_display_flush HADAL_WAYLAND.display_flush
#define wl_display_cancel_read HADAL_WAYLAND.display_cancel_read
#define wl_display_dispatch_pending HADAL_WAYLAND.display_dispatch_pending
#define wl_display_read_events HADAL_WAYLAND.display_read_events
#define wl_display_connect HADAL_WAYLAND.display_connect
#define wl_display_disconnect HADAL_WAYLAND.display_disconnect
#define wl_display_roundtrip HADAL_WAYLAND.display_roundtrip
#define wl_display_get_fd HADAL_WAYLAND.display_get_fd
#define wl_display_prepare_read HADAL_WAYLAND.display_prepare_read
#define wl_proxy_marshal HADAL_WAYLAND.proxy_marshal
#define wl_proxy_add_listener HADAL_WAYLAND.proxy_add_listener
#define wl_proxy_destroy HADAL_WAYLAND.proxy_destroy
#define wl_proxy_marshal_constructor HADAL_WAYLAND.proxy_marshal_constructor
#define wl_proxy_marshal_constructor_versioned HADAL_WAYLAND.proxy_marshal_constructor_versioned
#define wl_proxy_get_user_data HADAL_WAYLAND.proxy_get_user_data
#define wl_proxy_set_user_data HADAL_WAYLAND.proxy_set_user_data
#define wl_proxy_set_tag HADAL_WAYLAND.proxy_set_tag
#define wl_proxy_get_tag HADAL_WAYLAND.proxy_get_tag
#define wl_proxy_get_version HADAL_WAYLAND.proxy_get_version
#define wl_proxy_marshal_flags HADAL_WAYLAND.proxy_marshal_flags
...
/** The internal API for dynamically loaded wayland-client. Needed for generated protocols. */
extern struct hadopelagic_api_wl HADAL_WAYLAND;
...
#define xkb_context_new HADAL_XKBCOMMON.context_new
#define xkb_context_unref HADAL_XKBCOMMON.context_unref
#define xkb_keymap_new_from_string HADAL_XKBCOMMON.keymap_new_from_string
#define xkb_keymap_unref HADAL_XKBCOMMON.keymap_unref
#define xkb_keymap_mod_get_index HADAL_XKBCOMMON.keymap_mod_get_index
#define xkb_keymap_key_repeats HADAL_XKBCOMMON.keymap_key_repeats
#define xkb_keymap_key_get_syms_by_level HADAL_XKBCOMMON.keymap_key_get_syms_by_level
#define xkb_state_new HADAL_XKBCOMMON.state_new
#define xkb_state_unref HADAL_XKBCOMMON.state_unref
#define xkb_state_key_get_syms HADAL_XKBCOMMON.state_key_get_syms
#define xkb_state_update_mask HADAL_XKBCOMMON.state_update_mask
#define xkb_state_key_get_layout HADAL_XKBCOMMON.state_key_get_layout
#define xkb_state_mod_index_is_active HADAL_XKBCOMMON.state_mod_index_is_active
#define xkb_compose_table_new_from_locale HADAL_XKBCOMMON.compose_table_new_from_locale
#define xkb_compose_table_unref HADAL_XKBCOMMON.compose_table_unref
#define xkb_compose_state_new HADAL_XKBCOMMON.compose_state_new
#define xkb_compose_state_unref HADAL_XKBCOMMON.compose_state_unref
#define xkb_compose_state_feed HADAL_XKBCOMMON.compose_state_feed
#define xkb_compose_state_get_status HADAL_XKBCOMMON.compose_state_get_status
#define xkb_compose_state_get_one_sym HADAL_XKBCOMMON.compose_state_get_one_sym
...
/** The internal api for dynamically loaded xkbcommon library. */
extern struct hadopelagic_api_xkb HADAL_XKBCOMMON;
